...
<div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="rounded-[8px] border border-[#d7e3f4] gradient-surface-deep p-6">
          ...
          <div className="mt-5 h-56 rounded-lg bg-white border border-[#E4E7EC] p-4">
            <div className="h-10 bg-[#E4E7EC] rounded animate-pulse" />
            <div className="mt-3 grid grid-cols-3 gap-3 h-[76%] items-end">
              <div className="bg-[#E4E7EC] rounded w-full h-2/3 animate-pulse" />
              <div className="bg-[#E4E7EC] rounded w-full h-3/5 animate-pulse" />
              <div className="bg-[#E4E7EC] rounded w-full h-4/5 animate-pulse" />
            </div>
          </div>
        </div>

        <div className="rounded-[8px] border border-[#E4E7EC] bg-white p-6">
          <div className="text-sm font-semibold text-[#101828]">Coaching Tip Effectiveness</div>
          <div className="text-xs text-[#667085] mt-1">Placeholder chart shape</div>
          <div className="mt-5 h-56 rounded-lg bg-white border border-[#E4E7EC] p-4">
            <div className="h-10 bg-[#E4E7EC] rounded animate-pulse" />
            <div className="mt-3 space-y-3">
              {Array.from({ length: 4 }).map((_, idx) => (
                <div key={idx} className="flex items-center gap-3">
                  <div className="w-16 h-3 bg-[#E4E7EC] rounded animate-pulse" />
                  <div className="flex-1 h-3 bg-[#E4E7EC] rounded animate-pulse" />
                </div>
              ))}
            </div>
          </div>
